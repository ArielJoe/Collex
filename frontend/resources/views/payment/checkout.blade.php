    ...
    <div class="min-h-screen bg-gray-50 px-4 py-8 md:py-12">
        <div class="container mx-auto max-w-6xl">
            ...
            <div class="text-center mb-10">
                <span class="text-xs font-semibold text-red-600 uppercase tracking-wider">KONFIRMASI PEMBELIAN ANDA</span>
                ...
                <form action="{{ route('checkout.process') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-100">
                                <h2 class="text-xl font-semibold text-gray-800 mb-6 pb-2 border-b border-gray-200">Detail
                                    Pembeli</h2>
                                <div class="space-y-5">
                                    <div>
                                    ...
                                    <div>
                                        <label for="contact_no" class="block mb-2 text-sm font-medium text-gray-700">Nomor
                                            Kontak:</label>
                                        <div class="relative">
                            ...
                            <!-- Payment Proof Card -->
                            <div class="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-100">
                                <h2 class="text-xl font-semibold text-gray-800 mb-6 pb-2 border-b border-gray-200">Bukti
                                    Pembayaran</h2>
                                <p class="text-sm text-gray-600 mb-6">Screenshot & unggah bukti pembayaran Anda di sini:
                                </p>

                                <!-- Payment Instructions -->
                                <div class="bg-blue-50 border border-blue-100 text-blue-700 p-4 rounded-lg text-sm mb-6">
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-2">Setelah transfer, mohon unggah bukti pembayaran di bawah ini.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="uploadContainer"
                                    ...
                                    <div class="flex flex-col items-center justify-center space-y-3">
                                        ...
                                        <input type="file" name="proof_url_file" id="proof_url_file" class="hidden"
                                            required accept="image/jpeg,image/png,image/gif,application/pdf">
                                    </div>
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 sticky top-8">
                                ...
                                <!-- Event Poster -->
                                @php
                                    $firstCartItem = isset($cartItems) && count($cartItems) > 0 ? $cartItems[0] : null;
                                    $eventPoster = $firstCartItem['poster_url'];
                                    $eventTitle = $firstCartItem['event_name'];
                                    // if ($firstCartItem && isset($firstCartItem['event_id']['poster_url'])) {
                                    //     $eventPoster = $firstCartItem['event_id']['poster_url'];
                                    // } elseif (isset($event['data']['poster_url'])) {
                                    //     $eventPoster = $event['data']['poster_url'];
                                    // } else {
                                    //     $eventPoster = 'https://via.placeholder.com/300x200?text=Event+Poster';
                                    // }\

                                    // if ($firstCartItem && isset($firstCartItem['event_id']['name'])) {
                                    //     $eventTitle = $firstCartItem['event_id']['name'];
                                    // } elseif (isset($event['data']['name'])) {
                                    //     $eventTitle = $event['data']['name'];
                                    // } else {
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="cart-items-container space-y-3 pr-2">
                                        @foreach ($cartItems as $item)
                                            <div class="flex items-start">
                                                {{-- <div
                                                    class="flex-shrink-0 h-10 w-10 rounded-md bg-gray-100 overflow-hidden border border-gray-200">
                                                    <img src="{{ $item['image_url'] ?? 'https://via.placeholder.com/100?text=Item' }}"
                                                        class="h-full w-full object-cover" alt="Item Image">
                                                </div> --}}
                                                <div class="ml-3">
                    ...
                    <div
                        ...
                        <button type="submit" id="submitPaymentBtn"
                            class="w-full sm:w-auto flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-70">
                            <span id="buttonText">Simpan dan Lanjutkan</span>
                            <svg id="loadingSpinner" class="hidden animate-spin -ml-1 mr-3 h-5 w-5 text-white"
