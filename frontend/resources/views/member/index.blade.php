                ...
                <div
                    ...
                    <div class="md:w-1/3 lg:w-1/4">
                        <img src="{{ $event['poster_url'] ?? 'https://via.placeholder.com/400x500.png?text=No+Image' }}"
                            alt="{{ $event['eventName'] }} Poster" class="w-full h-48 md:h-full object-cover">
                    </div>
                            ...
                            @if ($event['paymentStatus'] === 'confirmed')
                                <div class="mt-6 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
                                    ...
                                    <div class="flex items-center space-x-4">
                                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data={{ urlencode($event['eventId']) }}"
                            ...
                            @elseif ($event['paymentStatus'] === 'pending')
                                <div class="mt-6 p-4 bg-amber-50 rounded-lg border border-amber-200">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-sm text-amber-800">QR code will be available once payment is
                                            confirmed.</p>
                                    </div>
                                </div>
